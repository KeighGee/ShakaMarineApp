...
public class HomePage extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("31°2'36\"E, 29°52'0\"S", null).show();
            }
        });
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        //Returning to the current tabs
            switch (position) {
                case 0:
                    Tab1Accommodation tab1 = new Tab1Accommodation();
                    return tab1;
                case 1:

                    Tab2Attractions tab2 = new Tab2Attractions();
                    return tab2;
                case  2:

                    Tab3Restaurant tab3 = new Tab3Restaurant();
                    return tab3;
                default:
                    return null;
            }
